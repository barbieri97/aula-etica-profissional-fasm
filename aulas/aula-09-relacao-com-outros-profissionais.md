---
theme: none
title: Aula 09 · Relação com outros profissionais
info: Os Arts. 6º e 7º do Código — o que se compartilha com quem não é psicólogo e
  as quatro únicas situações em que se pode intervir no serviço de outro —, com a
  resolução da perícia e um estudo de caso
date: "2026-10-01"
...
itens:
  - { tema: O que se compartilha, desc: "Art. 6º — encaminhar, e contar só o relevante" }
  - { tema: Quando se pode intervir, desc: "Art. 7º — as quatro portas, e são só quatro" }
  - { tema: Perito e assistente técnico, desc: "Res. CFP 008/2010 — dois papéis que não se acumulam" }
...
Hoje é a **terceira família**: os Arts. 6º e 7º, a menor de todas — e a que faz
fronteira direta com o sigilo.

<!--
Marque a terceira caixa. Dois artigos e seis alíneas.

Diga que a fronteira com a família seguinte é porosa de propósito: o Art. 6º, "b"
trata de compartilhar informação resguardando o caráter confidencial, que é
exatamente o assunto do Art. 9º. A separação é de destinatário, não de tema —
aqui, quem recebe não é psicólogo.
-->

---
layout: secao
numero: "01"
title: O que se compartilha
note: Art. 6º — com quem não é psicólogo, o critério é qualificar o serviço.
---
...
title: No relacionamento com profissionais não psicólogos
fonte: CFP, 2005, p. 12 — alíneas "a" e "b"
---
...
A alínea "b" tem três movimentos, e todos caem em prova:
1. somente informações RELEVANTES — o critério é qualificar o serviço, não
   informar por cortesia;
...
layout: default
---
# Art. 6º na prática · o que se conta à equipe

<Nota tipo="alerta" titulo="No serviço">

Numa reunião de rede sobre uma adolescente, a psicóloga precisa justificar por
que pede prioridade na vaga. Relata que a menina foi vítima de violência sexual e
descreve o episódio.

Relevante para a vaga: que há risco e que o caso é prioritário. O relato do
episódio não qualifica a decisão — e, uma vez dito na reunião, não volta.

</Nota>

<Fonte>Em equipe, o registro segue a mesma régua. <Norma>Art. 12 · CEPP 2005</Norma> · <Norma>Res. CFP 001/2009, Art. 6º</Norma></Fonte>
...
layout: secao
numero: "02"
title: Quando se pode intervir
note: Art. 7º — quatro situações, e fora delas não se entra no serviço de outro.
---
...
---
<Grade :cols="2">
<Artigo numero="Art. 7º · caput, a e b" norma="CEPP 2005 · p. 12">
...
<Artigo numero="Art. 7º · c e d" norma="CEPP 2005 · p. 12">
...
<!--
Artigo de lista fechada: fora dessas quatro situações, não se intervém. E é o
único do capítulo que trata da relação entre dois psicólogos sobre a MESMA pessoa
atendida.

A alínea "b" tem uma obrigação embutida que passa despercebida: dar IMEDIATA
CIÊNCIA ao profissional. Intervir em emergência é permitido; intervir e não
avisar, não.

A alínea "c" resolve o caso mais comum na clínica — a pessoa que procura outro
psicólogo dizendo que "parou" com o anterior. O artigo exige informação EXPRESSA
de interrupção voluntária e DEFINITIVA. Não basta supor; pergunta-se.

Repare que a alínea "d" torna a intervenção parte do método, e não exceção: em
...
layout: caso
numero: "01"
title: A pessoa que já é atendida por outro
perguntas:
  - Qual das quatro alíneas do Art. 7º alcança este caso — e falta alguma coisa para que ela alcance?
  - O que o psicólogo pode perguntar sem violar o sigilo da colega?
  - O que muda se, em vez de desconforto, houvesse risco de vida?
tempo: 8 min
fonte: caso construído para a aula, sem correspondência com situação real
---
Uma mulher procura atendimento e conta, na primeira entrevista, que faz terapia
há dois anos com outra psicóloga. Diz que está insatisfeita e que quer começar
...
1. NENHUMA alínea alcança o caso como está. Não há pedido da colega ("a"), não há
   emergência ("b"), não há interrupção voluntária e DEFINITIVA informada ("c") —
   "em paralelo" é o oposto disso — e não é trabalho multiprofissional ("d").
   O que falta para a alínea "c" alcançar é a decisão da própria pessoa de
   encerrar, e a informação expressa disso.

2. Sobre o que perguntar: o sigilo é da colega para com a paciente, não da
   paciente para com o novo psicólogo. Ela pode contar o que quiser. O que o
   psicólogo não pode é buscar informação COM A COLEGA sem que se configure uma
   das quatro situações. Perguntar à própria pessoa é legítimo.
...
tacitamente uma condição que o Código não permite é uma decisão, não uma omissão.
-->
...
<Grade :cols="2">
<Cartao rotulo="o que há" titulo="Insatisfação e paralelo">

Ela quer começar “em paralelo, por um tempo”. Não é interrupção **voluntária e
definitiva**, e não foi informada expressamente.

</Cartao>
<Cartao rotulo="o que falta" titulo="A decisão dela" destaque>

A alínea “c” só alcança quando a própria pessoa **encerra** o trabalho anterior e
isso é informado. Até lá, nenhuma das quatro portas está aberta.

</Cartao>
</Grade>

<Nota tipo="info" titulo="Sobre o pedido de não informar a colega">

O sigilo é da colega **para com** a paciente. O que ela conta ao novo psicólogo é
dela. O que ele não pode é buscar informação com a colega fora das quatro
situações.
...
começar. Isso não é intervir no serviço alheio — é trabalho clínico.
-->

---
layout: secao
numero: "03"
title: Perito e assistente técnico
note: Res. CFP 008/2010 — dois papéis, e a vedação de acumulá-los.
---

---
layout: documento
artigo: Res. CFP 008/2010
norma: Atuação do psicólogo como perito e assistente técnico no Judiciário
title: O psicoterapeuta das partes não pode ser perito
fonte: CFP, Res. CFP nº 008, de 30/6/2010, Art. 10, caput e inciso I
---

Com intuito de preservar o direito à intimidade e equidade de condições, é
**vedado ao psicólogo que esteja atuando como psicoterapeuta das partes**
...
artigo: Res. CFP 008/2010
norma: Atuação do psicólogo como perito e assistente técnico no Judiciário
title: E o documento que instrui o juízo
fonte: CFP, Res. CFP nº 008, de 30/6/2010, Art. 10, inciso II
---
...
# Dois papéis, e a distância entre eles

<Grade :cols="2">
<Cartao rotulo="perito" titulo="Nomeado pelo juízo">

Produz informação **para o processo**. O que documenta não é atendimento, e o
periciando não é paciente.

</Cartao>
<Cartao rotulo="assistente técnico" titulo="Indicado pela parte">

Acompanha e critica tecnicamente o trabalho pericial. Recomenda-se **Termo de
Compromisso** com anuência da parte.

</Cartao>
</Grade>

<Nota tipo="info" titulo="Um não assiste ao trabalho do outro">

O assistente técnico não deve estar presente durante os procedimentos do perito, e
vice-versa. <Norma>Res. CFP 008/2010, Arts. 2º e 9º</Norma>

</Nota>

<!--
A turma chega achando que perito e assistente técnico são o mesmo papel com nomes
diferentes. Não são: um é nomeado pelo juízo e produz a prova; o outro é indicado
pela parte e faz a crítica técnica dela.

O Art. 1º da resolução amarra os dois pela mesma exigência: evitar qualquer
interferência que prejudique a autonomia teórico-técnica e que constranja o
periciando.

O Art. 9º recomenda o Termo de Compromisso do assistente técnico, firmado no
...
# E dentro da equipe · o registro é único

<Grade :cols="2">
<Cartao rotulo="Art. 6º, “b”" titulo="O que se diz">

Só o relevante para qualificar o serviço, com o sigilo assinalado a quem recebe.

</Cartao>
<Cartao rotulo="Res. 001/2009" titulo="O que se escreve">

Em serviço multiprofissional, o registro é feito em **prontuário único** — e nele
vão apenas as informações necessárias aos objetivos do trabalho.

</Cartao>
</Grade>

<Nota tipo="alerta" titulo="O caderno paralelo não é saída">

Manter um registro fora do prontuário não tem amparo, e numa requisição judicial
aparece do mesmo jeito. A saída é **escrever menos**.
...
informações necessárias ao cumprimento dos objetivos do trabalho.

A exceção prevista, e ela é importante: documentos resultantes de instrumentos de
avaliação psicológica ficam em pasta de acesso exclusivo do psicólogo — Art. 2º,
V, da mesma resolução. Isso não é prontuário paralelo, é material privativo.
-->
...
Não pode: falta o consentimento formal de ambos.

</Cartao>
<Cartao rotulo="c">

Pode, se o juízo requisitar.

</Cartao>
<Cartao rotulo="d">

Pode, se descrever só o que observou.
...
Um psicólogo atende um menino de 10 anos encaminhado pela escola por
“desorganização”. Depois de seis sessões, escreve à coordenadora pedagógica um
e-mail com o histórico familiar, a separação dos pais, o episódio de violência que
o menino relatou e a sugestão de adaptações em sala.
...
caso — é a consequência previsível de não assinalar a responsabilidade de quem
recebe.
-->
...
A escola encaminhou o caso e tem direito a retorno. O psicólogo cumpriu o Art. 1º,
“h” — orientar sobre os encaminhamentos apropriados — e sugeriu adaptações
concretas, que é o que a escola pode fazer.

::direita::

A alínea manda compartilhar **somente informações relevantes para qualificar o
serviço prestado**. Histórico familiar e episódio de violência não qualificam
adaptação de sala.

E faltou **assinalar a responsabilidade de quem recebe** — por isso o e-mail
circulou.
...
Devolver **as adaptações**, sem o conteúdo das sessões, com uma linha dizendo que
a informação é sigilosa — e encaminhar o episódio de violência à rede de proteção.
...
title: O que fica
pontos:
  - 'Com quem não é psicólogo, o critério é <span class="ds-em">qualificar o serviço</span>'
  - 'Assinalar o sigilo a quem recebe é o que <span class="ds-em">transfere o dever</span>'
...
- CFP. **Res. CFP nº 010/05** — o **CEPP**, Arts. 6º e 7º (p. 12).
- CFP. **Res. CFP nº 008/2010**, Arts. 1º, 2º, 9º e 10 — perito e assistente técnico.
- CFP. **Res. CFP nº 001/2009**, Art. 6º — prontuário único em serviço multiprofissional.
- CFP. **Res. CFP nº 06/2019** — documentos escritos; revogou a Res. 007/2003, citada na resolução de 2010.

<!--
Referências completas:

- CFP. Resolução CFP nº 010/05, de 21 de julho de 2005. Aprova o Código de Ética
  Profissional do Psicólogo. Brasília: CFP, 2005. Arts. 6º e 7º, p. 12.
- CFP. Resolução CFP nº 008, de 30 de junho de 2010. Dispõe sobre a atuação do
  psicólogo como perito e assistente técnico no Poder Judiciário. Art. 1º
  (autonomia e não constrangimento), Art. 2º e parágrafo único (um não assiste ao
  trabalho do outro), Art. 9º (Termo de Compromisso do assistente técnico), Art.
  10, incisos I e II e parágrafo único (vedação ao psicoterapeuta das partes).
- CFP. Resolução CFP nº 001/2009, de 30 de março de 2009. Art. 2º, V (pasta de
  acesso exclusivo para material de avaliação) e Art. 6º e parágrafo único
  (prontuário único).
